...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    // For now, provide direct download link instead of email
    const successResponse = `
      <div style="background: #f0fff4; border: 2px solid #38a169; border-radius: 8px; padding: 20px; color: #2d3748; text-align: center;">
        ...
        <a href="/assets/Reality_Check_Guide_Veritas_BS.pdf" 
           download="Reality-Check-Methodology-Guide.pdf"
           style="display: inline-block; background: #38a169; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 16px 0;">
          📥 Download Guide Now
        </a>
